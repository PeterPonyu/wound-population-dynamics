...
Analysis code is released under the MIT License. Manuscripts, figures and source-study data remain under their respective rights and repository terms. The accompanying software archive, authored by Zeyu Fu, is available at \url{https://github.com/PeterPonyu/wound-population-dynamics}. An independently archived software release is available at \url{https://doi.org/10.5281/zenodo.22872454}.
\FloatBarrier
